...
export default function Admin() {
  return (
    <div className="relative isolate overflow-hidden rounded-2xl bg-gray-900 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <div className="mt-4 font-semibold text-white">Total Post</div>
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="mt-4 font-semibold text-white">Total Categories</div>
              <div className="mt-2 leading-7 text-gray-400">
